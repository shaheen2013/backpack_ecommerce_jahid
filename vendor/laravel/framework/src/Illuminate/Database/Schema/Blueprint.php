...
class Blueprint
{
     ...
     * @param int $precision
     */
    public function status($precision = 0)

    {
        $this->integer('status', $precision)->default(1);
     ...
     * @param int $precision
     */
    public function createBy($precision = 0)
    {
        $this->integer('created_by', $precision)->default(1);
